...
public class V149 {
	...
	public void prepare(){
		...
		IElement myCheckbox = tester.getElementByXPath("//td[text()='test']/..//input[@type='checkbox']");
	...
	@Test
	public void page(){
		Vulnerabilities.page(tester,"users","Edit");
	...
	@Test
	public void page2(){
		Vulnerabilities.page2(tester,"users","Edit");
		tester.assertMatch("Edit User");
		tester.assertLinkNotPresentWithText("malicious");
	}
	...
	@Test
	public void delete(){
		Vulnerabilities.delete(tester,"users","Edit","test");
